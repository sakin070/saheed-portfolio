...
- Personal story: Lagos, moving to Canada at 18, software engineering at the University of Ottawa, now SF. Describe Ford experience through the work: he was part of the camera team, then worked on drive modes, helping software use information about a vehicle’s surroundings to make parking and drive mode decisions. Show the connection between software and vehicle behavior. These details are user supplied; do not invent additional projects, technologies, titles, dates, metrics, or claims of sole ownership. Morgan Stanley, Kinaxis, and Software for Love provide additional background.
...
- Direct user statements — farms, personal motivations, interests, love of mentoring, camera and drive modes work at Ford, audience and tone
