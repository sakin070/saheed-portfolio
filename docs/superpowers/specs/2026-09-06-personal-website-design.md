...
- Other ventures: an 18-hectare oil palm plantation, a layer chicken farm, and Lucky Star lottery. Ownership/launch claims are user supplied. The user confirmed that ESS Nigeria Limited was the company and Lucky Star was its product; preserve this distinction in the homepage and writing. The Guardian’s May 1, 2023 report identifies Saheed as the company’s managing director and describes its Lagos customer event with scratch-and-win games and a live prize draw. Use these concrete details in the product card and link the coverage by name. The user also confirmed the relevance of the Lagos regulator’s entry for “Ess Lottory Services Limited,” which lists a historical March 2023–March 2024 period. These sources do not establish a founding date, operating scale, current status, or social handles. Searches of public Instagram/X results have not yet identified verified company accounts; do not link unrelated brands with the same name.
