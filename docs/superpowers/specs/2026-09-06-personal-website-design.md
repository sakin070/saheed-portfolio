...
- Other businesses: an 18-hectare oil palm plantation, a layer chicken farm, and Lucky Star lottery. Ownership/launch claims are user supplied. The Guardian’s May 1, 2023 report identifies Saheed as Lucky Star’s managing director and describes its Lagos customer event with scratch-and-win games and a live prize draw. Use these concrete details in the company card and link the coverage by name. The report does not establish a founding date, operating scale, current status, or social handles. Searches of public Instagram/X results have not yet identified verified company accounts; do not link unrelated brands with the same name.
