...
try {
  ...
  </style></head><body><div class="card"><header><b>saheed<span>.</span></b><span>San Francisco, by way of Lagos & Canada</span></header><h1>Saheed<br>Akinbile<span>.</span></h1><p>Founder & engineer.<br>Co-founder & CTO, Minicor (YC Spring 2026)</p><div class="monogram" aria-hidden="true">s<span>.</span></div><footer><span>Things that move. The software behind them.</span><span>saheedakinbile.com</span></footer></div></body></html>`);
